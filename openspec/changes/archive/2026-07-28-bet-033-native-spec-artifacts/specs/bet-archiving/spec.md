...
- **WHEN** a user invokes `oprim:archive BET-NNN` and `oprim/bets/BET-NNN.../tasks.md` exists with at least one `- [ ]` unchecked item
...
- **WHEN** a user invokes `oprim:archive BET-NNN` and `oprim/bets/BET-NNN.../tasks.md` exists with every item checked (`- [x]`)
