...
This document defines the criteria-to-measurement mapping, generated output format, and review update flow for Open Product Primer's KPI automation pipeline.

## 5.1 Criteria-to-measurement mapping
...
## 5.3 Review artifact update flow

After a measurement run, the KPI review artifact and upstream decision artifacts are updated in sequence:
