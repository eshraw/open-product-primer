# note-authoring Specification

## Purpose

TBD — defines atomic note scaffolding in `oprim/notes/`: id assignment, minimal always-on frontmatter, the OKF-tier frontmatter upgrade, the self-seeding tag vocabulary, and mention-based bet linkage (rather than directory nesting).
