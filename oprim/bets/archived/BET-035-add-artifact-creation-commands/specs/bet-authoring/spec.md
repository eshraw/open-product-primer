...
The command SHALL write a complete bet-decision artifact including status (defaulting to "Build now"), decision date, owner, why-now rationale, alternatives considered, expected outcomes, and kill criteria.
