...
import { installAgentSkills, writeAgentInstructionFile, codexInstructions, geminiInstructions, poolsideInstructions, vibeInstructions, qwenInstructions, CLAUDE_COMMANDS, CLAUDE_SKILLS, POOLSIDE_SKILLS, VIBE_SKILLS, QWEN_SKILLS, CURSOR_COMMANDS } from '../lib/install-agent';
...
describe('rules.<artifact> guidance in generated skill content', () => {
  ...
  it('Codex/Gemini/Poolside/Vibe/Qwen inline workflow text references rules.bet / rules.pdr / rules.review', () => {
    for (const instructions of [codexInstructions(), geminiInstructions(), poolsideInstructions(), vibeInstructions(), qwenInstructions()]) {
...
describe('decisions-view regeneration in oprim-pdr', () => {
  ...
  it('Codex/Gemini/Poolside/Vibe/Qwen inline workflow text runs generate-decisions-view.js', () => {
    for (const instructions of [codexInstructions(), geminiInstructions(), poolsideInstructions(), vibeInstructions(), qwenInstructions()]) {
...
describe('oprim-spec skill installation', () => {
  ...
  it('installs oprim-spec for cursor, poolside, vibe, and qwen when framework is native', () => {
...
describe('fresh install renders every bundled workflow (bet-027)', () => {
  it('installs all 8 Claude skills, 4 commands, and every Cursor/Poolside/Vibe/Qwen skill matching the bundled exports', () => {
    installAgentSkills('claude', tmpDir);
